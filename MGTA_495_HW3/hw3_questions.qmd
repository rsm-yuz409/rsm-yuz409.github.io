...
The exponential function is important here because \(\lambda_i\) must always be positive. The linear part, \(X_i\beta\), can be any real number, but after applying \(\exp(\cdot)\), the predicted patent rate is guaranteed to stay above zero.
